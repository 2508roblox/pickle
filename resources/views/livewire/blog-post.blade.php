 <div>
     ...
     <head>
         ...
         <link rel="canonical" href="https:{{ asset('asset/blogs/court-reviews/pickleball-factory-subang-ss13') }}" >
...
@endphp
         ...
         <meta name="description" content="Discover the lifestyle hub Pickleball Factory in Subang SS13. Enjoy future dining and improved court features at this dynamic venue.">




         <meta property="og:site_name" content="Picklefox.com">
         <meta property="og:url" content="https:{{ asset('asset/blogs/court-reviews/pickleball-factory-subang-ss13') }}" >
         <meta property="og:title" content="Pickleball Factory @ Subang SS13: A New Hangout">
         <meta property="og:type" content="article">
         <meta property="og:description" content="Discover the lifestyle hub Pickleball Factory in Subang SS13. Enjoy future dining and improved court features at this dynamic venue.">
         <meta property="og:image" content="http:{{ asset('asset/cdn/shop/articles/WhatsApp_Image_2024-09-22_at_12.43.09.jpg') }}" >
         <meta property="og:image:secure_url" content="https:{{ asset('asset/cdn/shop/articles/WhatsApp_Image_2024-09-22_at_12.43.09.jpg') }}" >
         <meta property="og:image:width" content="1280">
         <meta property="og:image:height" content="960">
         <meta name="twitter:card" content="summary_large_image">
         <meta name="twitter:title" content="Pickleball Factory @ Subang SS13: A New Hangout">
         <meta name="twitter:description" content="Discover the lifestyle hub Pickleball Factory in Subang SS13. Enjoy future dining and improved court features at this dynamic venue.">
         ...
         <script id="__st">
             var __st = {
                 "a": 65451524292
                 , "offset": 28800
                 , "reqid": "4ab98005-5c07-4a8a-ab4d-f57e7dda36cd-1730719838"
                 , "pageurl": "picklefox.com\/blogs\/court-reviews\/pickleball-factory-subang-ss13"
                 , "s": "articles-560186589380"
                 , "u": "a10455dfebfa"
                 , "p": "article"
                 , "rtyp": "article"
                 , "rid": 560186589380
         ...
         <!-- END app snippet -->
         <!-- BEGIN app snippet: smartseo.article.jsonld -->
         <!--JSON-LD data generated by Smart SEO-->
         <script type="application/ld+json">
             {
                 "@context": "https://schema.org"
                 , "@type": "Article"
                 , "about": "The venue is designed to be a lifestyle hangout spot, with a restaurant slated to open soon, adding to its appeal. When we visited during its soft launch, there were still some areas in need of improvement, and we plan to revisit in a few months to see how it develops.Our biggest concerns were th..."
                 ...
                 , "articleBody": "The venue is designed to be a lifestyle hangout spot, with a restaurant slated to open soon, adding to its appeal. When we visited during its soft launch, there were still some areas in need of improvement, and we plan to revisit in a few months to see how it develops.Our biggest concerns were the court’s limited runway space and subpar surface material. We noticed a few dead spots on the court where the ball didn’t bounce properly, which significantly impacted play. Additionally, the lighting wasn’t well-diffused, and combined with the nearby window, it made visibility tricky at times.At one point, I even hit my paddle against a pillar while trying to return a deep serve, which highlights some layout constraints. There were also water puddles to be seen, we aren&#39;t sure if these were due to cleaning the day before or the roof leaking.Overall, while it’s a solid attempt at creating a great venue, the current setup may not meet the expectations of intermediate to advanced players. We’re hopeful that these issues will be addressed as operations ramp up.Address:1, Jalan SS 13/3d, Subang Jaya Industrial Estate, 47500 Subang Jaya, Selangor, Malaysia"
                 , "author": {
                     "@type": "Person"
         ...
         <script defer src="https:{{ asset('asset/cdn/shopifycloud/perf-kit/shopify-perf-kit-1.0.1.min.js') }}"  data-application="storefront-renderer" data-shop-id="65451524292" data-render-region="gcp-asia-southeast1" data-page-type="article" data-theme-instance-id="140388761796" data-monorail-region="shop_domain" data-resource-timing-sampling-rate="10"></script>
     </head>
     ...
     <body class="gradient animate--hover-default">
         ...
         <main id="MainContent" class="content-for-layout focus-none" role="main" tabindex="-1">
             ...
             <section id="shopify-section-template--17738896212164__main" class="shopify-section section">
                 <link href="{{ asset('asset/cdn/shop/t/7/assets/section-blog-post.css') }}"  rel="stylesheet" type="text/css" media="all" />
                 ...
                 <article class="article-template">
                     ...
                     <div class="article-template__social-sharing page-width page-width--narrow scroll-trigger animate--slide-in">
                         ...
                         <share-button id="Share-template--17738896212164__main" class="share-button quick-add-hidden">
                     ...
                     <div class="article-template__back element-margin-top center scroll-trigger animate--slide-in">
                         <a href="/blogs " class="article-template__link link animate-arrow">
                     ...
                     <div class="article-template__comment-wrapper background-secondary">
                         <div id="comments" class="page-width page-width--narrow scroll-trigger animate--slide-in">
                            <form wire:submit.prevent="submitReview" class="comment-form">
                                @if (session()->has('message'))
                <p style="color: rgb(5, 174, 5);" class="success-message">{{ session('message') }}</p>
            @endif                              <h2>Để lại đánh giá</h2>
                                 <div>
                                     <div class="article-template__comment-fields">
                                         <div class="field field--with-error">
                                             <input type="text" wire:model="name"  id="CommentForm-author" class="field__input" autocomplete="name" value="" aria-required="true" required placeholder="Tên của bạn">
                                             <label class="field__label" for="CommentForm-author">Họ và tên
                                                 <span aria-hidden="true">*</span></label></div>
                                                   @error('name') <span class="error">{{ $message }}</span> @enderror
                                         <div class="field field--with-error">
                                             <input type="email"  wire:model="email"  id="CommentForm-email" autocomplete="email" class="field__input" value="" autocorrect="off" autocapitalize="off" aria-required="true" required placeholder="Email của bạn">
                                     ...
                                     <div class="field field--with-error">
                                         <textarea rows="5" wire:model="comment" id="CommentForm-body" class="text-area field__input" aria-required="true" required  placeholder="Nội dung đánh giá"></textarea>
                                 ...
                                 <p class="article-template__comment-warning caption">Lưu ý, bình luận của bạn cần được phê duyệt trước khi được xuất bản.</p>
