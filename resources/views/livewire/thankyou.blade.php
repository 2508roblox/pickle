                                            ...
                                            <div class="section__content section__content--bordered">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col col--md-two">
                                                        ...
                                                        <div class="qr-code">
                                                            <img src="https://vietqr.co/api/generate/{{ $settings->ngan_hang }}/{{ $settings->so_tai_khoan }}/VIETQR.CO/{{ number_format(50000, 0, ',', '.') }}/{{ $orderCode }}?style=2&logo=1&isMask=1&bg=61" alt="" width="100px">

                                                            <p>Vui lòng cọc 50.000đ để lên đơn.</p>
                                                        </div>
                                                        @else
                                                        @endif
                                                    </div>
                                                    <div class="col col--md-two">
                                                        ...
                                                        <div class="qr-code">
                                                            <img src="https://vietqr.co/api/generate/{{ $settings->ngan_hang}}/{{ $settings->so_tai_khoan}}/VIETQR.CO/{{ number_format($order->grand_total + $order->shipping_amount, 0, ',', '.')  }}/{{ $orderCode}}?style=2&logo=1&isMask=1&bg=61"
                                                                alt="" width="100px">
