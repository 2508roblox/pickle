<div>
    ...
    <head>
        ...
        @endphp
        <title>
            {{ $categoryName }}-  {{ $settings->website }} </title>


        <meta name="description" content="Discover the best pickleball courts with our comprehensive and unbiased court reviews, helping you find the perfect place to play in Malaysia and beyond.">
        ...
        <meta property="og:description" content="Discover the best pickleball courts with our comprehensive and unbiased court reviews, helping you find the perfect place to play in Malaysia and beyond.">
        ...
        <meta name="twitter:description" content="Discover the best pickleball courts with our comprehensive and unbiased court reviews, helping you find the perfect place to play in Malaysia and beyond.">
        ...
        <style data-shopify>
            ...
            @font-face {
                ...
                font-style: normal;
                font-display: swap;
                src: url("{{ asset('asset/cdn/fonts/roboto/roboto_n7.51ede27d5b58491d9cf07ad184108da52fef80b4.woff2?h1=Y2E3ODljLWNkLmFjY291bnQubXlzaG9waWZ5LmNvbQ&h2=cGlja2xlZm94LmNvbQ&h3=YWNfforjb3VudC5waWNrbGVmb3guY29t&hmac=310159012285a5085f931c07c9283e5ed774504d00e90868ff0326df5f81815d') }}") format("woff2"),
        ...
        <script defer src="https:{{ asset('asset/cdn/shopifycloud/perf-kit/shopify-perf-kit-1.0.1.min.js') }}" data-application="storefront-renderer" data-shop-id="65451524292" data-render-region="gcp-asia-southeast1" data-page-type="blog" data-theme-instance-id="140388761796" data-monorail-region="shop_domain" data-resource-timing-sampling-rate="10"></script>
    </head>
    ...
    <body class="gradient animate--hover-default">
        ...
        <main id="MainContent" class="content-for-layout focus-none" role="main" tabindex="-1">
            <section id="shopify-section-template--17738895589572__main" class="shopify-section section">
                ...
                <link href="{{ asset('asset/cdn/shop/t/7/assets/section-main-blog.css') }}" rel="stylesheet" type="text/css" media="all" />
                <style data-shopify>
