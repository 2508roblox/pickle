...
class Checkout extends Component
{
    ...
    public function placeOrder()
    {
        ...
        DB::transaction(function () {
            ...
            // Create the order
            $order = Order::create([
                'user_id' => auth()->id() ?? 1, // Giả sử người dùng đã xác thực
                'grand_total' => $this->total, // Tổng số tiền
                'payment_method' => $this->paymentMethod,
                'payment_status' => 'pending', // Trạng thái thanh toán
                'currency' => 'pending', // Trạng thái tiền tệ
                'shipping_method' => $this->shipping_method, // Phương thức vận chuyển
                'order_code' => $order_code, // Mã đơn hàng
                'notes' => $this->note, // Ghi chú
                'profit_loss' => $this->profit_loss, // Lợi nhuận hoặc lỗ
                'shipping_amount' => $this->shipping_amount, // Phí vận chuyển
            ]);
